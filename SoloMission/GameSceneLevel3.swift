...
class GameSceneLevel3: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        for i in 0...(num_backgrounds-1) {
            let string1 = "background_guapo_game_level3_"
        ...
        is_already_unlocked = highScoreNumberLevel3 >= unlock_level_points
...
//            self.brownie.image_brownie.position.x -= self.brownie.speed
    ...
    func runGameOver() {
        ...
        if gameScore > highScoreNumberLevel3 {
            let defaults = UserDefaults()
            defaults.set(gameScore, forKey: "HighScoreLevel3Saved")
        }
